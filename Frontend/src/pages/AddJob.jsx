...
const AddJob = () => {
  ...
  return (
    <form className='container bg-gray-100 p-4 border mt-3 ml-3 flex flex-col w-full items-start gap-3 '>
      ...
      <button className='w-28 py-3 bg-black text-white rounded mt-3'>ADD</button>
